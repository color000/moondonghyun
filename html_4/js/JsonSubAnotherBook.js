      $.ajax({
	   ...
	   var str4 = msg.documents[i].sale_price.toLocaleString()	  
                 ...
                 $("#subapi > div").eq(i).append("<img src='"+msg.documents[i].thumbnail+"'/>");
                 $("#subapi > div").eq(i).append("<h5>"+str2+"..."+"</h3>");
                 $("#subapi > div").eq(i).append("<h6>"+str3+"원"+"</h6>");
                 $("#subapi > div").eq(i).append("<span class='saleprice'>"+str4+"</span>"+"원");
