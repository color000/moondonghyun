      $.ajax({
	   ...
	   var str4 = msg.documents[i].sale_price.toLocaleString()	  
                 ...
                 $("#subapi2 > div").eq(i).append("<img src='"+msg.documents[i].thumbnail+"'/>");
                 $("#subapi2 > div").eq(i).append("<h5>"+str2+"..."+"</h3>");
                 $("#subapi2 > div").eq(i).append("<h6>"+str3+"원"+"</h6>");
                 $("#subapi2 > div").eq(i).append("<span class='saleprice'>"+str4+"</span>"+"원");
